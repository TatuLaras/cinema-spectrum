...
export namespace Metadata {
  ...
  function cache<T>(cacheIdentifier: string, prefix: MediaType, data: T): void {
  ...
  export async function getTvMetadataById(
    ...
    const details: TMDBTypes.TvDetails | null = await TMDB.getTvShow(tvShowId);
    ...
    for (let season of details.seasons) {
      ...
      const seasonDetail: TMDBTypes.SeasonDetails | null =
        await TMDB.getTvShowSeasonDetails(details.id, season.season_number);
